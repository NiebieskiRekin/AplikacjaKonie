...
const publicconfig = Buffer.from(ProcessEnv.FIREBASE_PUBLIC_NOTIFICATIONS_CONFIG_BASE64, 'base64').toString()
export const firebaseNotificationsPublicConfig = firebase_notifications_public_config_schema.parse(JSON.parse(publicconfig));
